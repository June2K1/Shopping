												...
												<div class="col-md-12 col-sm-12 already-registered-login">
													...
													?>
														...
														<form class="register-form" role="form" method="post">
															...
															<div class="form-group">
																<label class="info-title" for="Contact No.">SĐT<span>*</span></label>
															...
															<button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Lưu</button>
														</form>
													<?php } ?>
												</div>
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											...
											<form class="register-form" role="form" method="post" name="chngpwd" onSubmit="return valid();">
												...
												<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Lưu </button>
											</form>
