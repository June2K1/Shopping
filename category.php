                            ...
                            <div class="category-product  inner-top-vs">
                                <div class="row">
                                    ...
                                    if ($num > 0) {
                                                ...
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" alt="" width="200" height="300" style="width: 100%"></a>
                                                            </div><!-- /.image -->
                                                        </div><!-- /.product-image -->
                                                            ...
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    <li class="add-cart-button btn-group">
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <div class="action" style="color:#555555">Hết Hàng
                                                                            </div>
                                                                        <?php } ?>
                                                                    </li>
                                        ...
                                        <div class="col-sm-6 col-md-8 wow fadeInUp">
